...
int main(int argc, char **argv)
{
...

	{
		...
		OSG::Pnt3f fromCentreCamera(0,10,0);
	...
	/*	//create Transformations
		...
		OSG::Vec3f up1(1,0,1);
		OSG::Pnt3f at1(0,0,0);
		OSG::Pnt3f from1(0,  0, -10);
		navigator1.set(from1, at1, up1);
